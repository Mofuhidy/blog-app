...
second_post = Post.create(author: first_user, title: 'Hi', text: 'This is my second post', likes_counter: 0, comments_counter: 0)
third_post = Post.create(author: second_user, title: 'Me', text: 'This is my third post', likes_counter: 0, comments_counter: 0)
fourth_post = Post.create(author: second_user, title: 'Yo!', text: 'This is my fourth post', likes_counter: 0, comments_counter: 0)
