RSpec.describe 'User index method which is also homepage', type: :feature do
  before(:example) do
    @users = [
      User.create(name: 'Me', photo: 'user1.jpg', bio: 'Teacher from Yemen.', posts_counter: 10),
      User.create(name: 'You', photo: 'user2.jpg', bio: 'Teacher from Sanaa.', posts_counter: 5),
      User.create(name: 'He', photo: 'user3.jpg', bio: 'Teacher from Here.', posts_counter: 7),
      User.create(name: 'She', photo: 'user4.jpg', bio: 'Teacher from There.', posts_counter: 2)
    ]
    visit root_path
  end
