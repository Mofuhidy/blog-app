...
RSpec.describe 'User show method ', type: :feature do
  ...
  before(:example) do
    @user = User.create(name: 'Moha',
                        ...
                        bio: 'Teacher from Yemen.', posts_counter: 8)

    @posts = [Post.create(author: @user, title: 'Hi', text: 'This is first post', comments_counter: 0, likes_counter: 0),
              Post.create(author: @user, title: 'Hey', text: 'This is second post', comments_counter: 0, likes_counter: 0),
              Post.create(author: @user, title: 'What\'s up', text: 'This is third post', comments_counter: 0, likes_counter: 0)]
